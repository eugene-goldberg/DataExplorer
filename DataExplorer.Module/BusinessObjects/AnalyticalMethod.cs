...
namespace DataExplorer.Module.BusinessObjects
{
    ...
    public class AnalyticalMethod : BaseObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public AnalyticalMethod(Session session)
            : base(session)
        {
        }
        ...
        [Association("PerformanceMetricAnalyticalMethod", typeof(PerformanceMetric))]
        ...
        public string MethodDefinition
        {
            ...
            set
            {
                string oldValue = MethodDefinition;
                if (oldValue == value) return;
                methodDefinition = value;
                OnChanged("MethodDefinition", oldValue, value);
            }
        }
